...
% * <wafa.johal@gmail.com> 2018-01-10T11:46:59.418Z:
%
% ^.
...
% * <wafa.johal@gmail.com> 2018-01-10T11:47:12.629Z:
% 
% I suggest to change the title to CoReader: Effect of pointing gestures in co-reading activity with a humanoid robot
% 
% ^.
...
\end{figure}
% * <wafa.johal@gmail.com> 2018-01-10T12:10:08.539Z:
% 
% We should not use the eye tracking image since we are not using the eye tracking data
% 
% ^.
...
% TODO this sentence shouldn't be here but in the discussion
% However, in the high level the children are more diverse, some of them are more proficient and even read books above their level in the class, while some are just promoted and still adjusting to the new books.
...
%The last question on SMA is concerned about readers correction of the miscue which is not in the interest of our development.
...
%Inspired by SMA questions and our interest in the effect of images, 
...
%This type overwrites all the next two types of mistakes. 
...
% this table is useless if you already give these examples in the text
...
%In CoReader, the robot acts like a social reading companion, while the child helps it to correct its reading mistakes.
...
%This validation should show that we have designed the mistakes in accordance with our theoretical descriptions.  
...
%Then we demonstrate the correction percentage of each mistake type based on the pointing condition for each level. 
...
%and can be distracting for them.
...
%We were open to know their opinion and suggestions, and they were willing to give their inputs. 
...
%We will try to implement in our future development.
...
%This will be explained in more detail in the Further development section.
...
%While it is suggested that pointing has a positive effect in providing extra information, it can also have a negative effect on certain aspects of the child's attentional state of the task in hand.
...
Anonymized.
%We would like to thank Patrick Jefford, Justine Fisher, Nathan John Hobson and the staff of primary section of International School of Geneva for their participation, support, and understanding through this experiment. With special thanks to children who participated in our experiment being so enthusiastic and caring to help our robot.   
